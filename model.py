...
from tensorflow.keras.layers import Embedding, LSTM, Dense, TimeDistributed, Input, Dropout, LayerNormalization
...
def create_model():
    ...
    encoder_outputs1 = Dropout(0.3)(encoder_outputs1)
    encoder_lstm2 = LSTM(LSTM_UNITS, return_sequences=False, return_state=True)
